...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Boolean saveCategory(String categoryName) {
        ...
        if (temp == null) {
            ...
            return blogCategoryMapper.updateByPrimaryKeySelective(temp) > 0;
        }
        return false;
    }
    ...
    public Boolean deleteBatch(Integer[] ids) {
        ...
        int totalBlogsByCategoryId = blogMapper.getTotalBlogsByCategoryId(ids);
        if (totalBlogsByCategoryId > 0) {
            return false;
        } else {
            //修改tb_blog表
