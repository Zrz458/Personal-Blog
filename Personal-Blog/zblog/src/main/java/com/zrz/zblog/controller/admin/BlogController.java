...
import com.zrz.zblog.util.MyBlogUtils;
...
public class BlogController {
    ...
    public void uploadFileByEditormd(HttpServletRequest request,
        ...
        com.zrz.zblog.entity.File  f = new com.zrz.zblog.entity.File (newFileName,file.getContentType(),
                file.getSize(),new Date(),new Binary(file.getBytes()));
